...
/**
 * alias_replacer - replaces an aliases in the tokenized string
 * @info: the parameter struct
 *
 * Return: 1 if replaced, 0 otherwise
 */
int alias_replacer(info_t *info)
{
	int i;
	list_t *node;
	char *p;
...
/**
 * vars_replacer - replaces vars in the tokenized string
 * @info: the parameter struct
 *
 * Return: 1 if replaced, 0 otherwise
 */
int vars_replacer(info_t *info)
{
	int i = 0;
	list_t *node;
...
/**
 * string_replacer - replaces string
